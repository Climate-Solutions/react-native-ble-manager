...
- `scanningOptions` - `JSON` - user can control specific ble scan behaviors:
  ...
  - `deviceAddress` - `string[]` - In Android corresponds to the `ScanFilter` [deviceAddress](<https://developer.android.com/reference/android/bluetooth/le/ScanFilter.Builder#setDeviceAddress(java.lang.String)>).
